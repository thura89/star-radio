    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    <a href="{{ route('developer.new_project.index')}}" class="@yield('newproject-active')">
                        <i class="metismenu-icon pe-7s-portfolio"></i>
                        Developer New Properties
                    </a>
                    <a href="{{ route('developer.property.index')}}" class="@yield('property-active')">
                ...
                <li>
                    <a href="{{ route('developer.profile')}}" class="@yield('profile-active')">
                        <i class="metismenu-icon pe-7s-id"></i>
                        Profile
                    </a>
                    <a href="{{ route('developer.logout') }}"
