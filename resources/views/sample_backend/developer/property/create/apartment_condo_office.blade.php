        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Property Create @if ($category == 3) Apartment & Condo @else Office @endif
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('developer.property.create.apartcondo_office') }}" method="POST" id="create"
