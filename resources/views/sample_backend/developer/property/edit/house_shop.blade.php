        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('developer.property.update.house_shop') }}" class="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col form-group">
                                        ...
                                        value {{ $property->rentprice->rent_pay_type }}
                            ...
                            <div class="row">
                                @if ($category == 1)
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input value="{{ $property->situation->type_of_building }}" type="text"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="shop_type" class="form-control">
                                            ...
                                            @foreach (config('const.shop_type') as $key => $type)
                                                <option value="{{ $key }}" @if ($property->situation->shop_type == $key) selected @endif>
                                                    {{ $type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <div class="position-relative form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="refrigerator" value="1"
                                                    @if ($property->unitAmenity->refrigerator == 1) checked @endif class="form-check-input">
                                                Refrigerator
                                            </label>
                                        </div>
                                        <div class="position-relative form-check">
                                        ...
                                        <div class="position-relative form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="internet_wifi" value="1"
                                                    @if ($property->unitAmenity->internet_wifi == 1) checked @endif class="form-check-input">
                                                Internet
                                                Wifi
                                            </label>
                                        </div>
                                        <div class="position-relative form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="water_heater" value="1"
                                                    @if ($property->unitAmenity->water_heater == 1) checked @endif class="form-check-input">
                                                WaterHeater
                                            </label>
                                        </div>
                                        <div class="position-relative form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="security_cctv" value="1"
                                                    @if ($property->unitAmenity->security_cctv == 1) checked @endif class="form-check-input">
                                                Security CCTV
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="position-relative form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="dinning_table" value="1"
                                                    @if ($property->unitAmenity->dinning_table == 1) checked @endif class="form-check-input">
                                                Dinning
                                                Table
                                            </label>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    ...
                                                    class="form-check-input" @if ($property->buildingAmenity->fitness_center == 1) checked @endif>Fitness
                                                Center</label></div>
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                    ...
                                    <div class="col form-group">
                                        ...
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    ...
                                                    class="form-check-input" @if ($property->buildingAmenity->own_transformer == 1) checked @endif>Own
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\UpdateHouseRequest', '#update') !!}
