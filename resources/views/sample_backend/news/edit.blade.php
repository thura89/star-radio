        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.news.update',$data->id) }}" id="update"
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col form-group">
                                    ...
                                    <input value="{{ $data->post_title }}" type="text" name="post_title" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="preview_image mt-2">
                                @if ($data->images)
                                    <img src="/{{ config('const.news_img_path').$data->images}}" alt="">
                                @endif
                            </div>
                        </div>
                        {{-- Detail --}}
                        <div class="form-group">
                            <div class="row">
                                <div class="col form-group">
                                    ...
                                    <textarea name="post_letter" class="form-control">{{ $data->post_letter }}</textarea>
                                </div>
                            </div>
                        </div>
                        {{-- Terms And Condition --}}
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\UpdateNewsRequest', '#update') !!}
