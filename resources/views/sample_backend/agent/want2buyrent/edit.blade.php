        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('agent.want2buyrent.update',$data->id) }}" id="update"
                        method="POST">
                        @method('PUT')
                        @csrf
                        {{-- Property Type --}}
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="number" value="{{ $data->area_width }}" name="area_width" class="form-control">
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label for="area_length">Length</label>
                                            <input type="number" value="{{ $data->area_length }}" name="area_length" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
