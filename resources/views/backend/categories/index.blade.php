...
<div class="container-fluid page__heading-container">
    <div class="page__heading d-flex align-items-center">
        <div class="flex">
            ...
            <h1 class="m-0">@lang('category.category') </h1>
        </div>
        <a href="{{ route('admin.categories.create')}}" class="btn btn-primary ml-3">@lang('back_content.create') <i class="material-icons">add</i></a>
    </div>
</div>
